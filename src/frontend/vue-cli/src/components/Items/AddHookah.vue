                ...
                <div style="padding-top:30px" class="panel-body" >
                    ...
                    <form id="registerform" class="form-horizontal" role="form">
                        ...
                        <div style="margin-bottom: 25px" class="input-group">
                            ...
                            <input v-model="hookah.description" id="description" type="text" class="form-control" name="username" value="" placeholder="Описание">
                        </div>

                        <div style="margin-bottom: 25px" class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            <input v-model="hookah.type" id="type" type="text" class="form-control" name="email" placeholder="Тип">
                        </div>

                        <div style="margin-bottom: 25px" class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                            <input v-model="hookah.id" id="id" type="text" class="form-control" name="password" placeholder="Номер">
                        </div>

                        <div style="margin-bottom: 25px" class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                            <input v-model="hookah.price" id="price" type="text" class="form-control" name="password" placeholder="Цена">
                        </div>
...
<script>
    export default {
        ...
        computed: {
            returnGames(){
                return this.hookah.games = this.gamesStr.split(',')
            },
            src () {
                if (this.content) {
                    return this.content;
        ...
        methods: {
            submit(){
                if(this.isValid){
                    ...
                    this.isActive = true;
                    this.$http.post('hookah', this.data, {
                        headers: {
            ...
            selectImage (file) {
                ...
                for(let field in this.hookah){
                    console.log(field, this.hookah[field])
                    this.data.append(field,this.hookah[field]);
                }
                this.file = file;
