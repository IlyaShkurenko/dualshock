        ...
        <form method="post" action="/">
            <div>
                <label for="name">
                    ...
                    <input type="text" id="name" name="name" value="" placeholder="Ваше имя" required="required" tabindex="1" autofocus="autofocus" />
                </label>
            </div>
            <div>
                <label for="email">
                    <span class="required">Телефон: *</span>
                    <input type="email" id="email" name="email" value="" placeholder="Ваш телефон" tabindex="2" required="required"/>
                </label>
            </div>
            <div>
                <label for="name">
                    <span class="required">Количество людей</span>
                    <input type="text" id="name" name="name" value="" placeholder="Количество" required="required" tabindex="1" autofocus="autofocus" />
                </label>
            </div>
            <div>
                <label for="subject">
